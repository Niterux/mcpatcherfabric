...
public class CompassSpriteMixin {
	...
	@Redirect(method = "Lnet/minecraft/client/render/texture/CompassSprite;<init>(Lnet/minecraft/client/Minecraft;)V",
	...
	@ModifyConstant(method = "Lnet/minecraft/client/render/texture/CompassSprite;<init>(Lnet/minecraft/client/Minecraft;)V",
	...
	@ModifyConstant(method = "Lnet/minecraft/client/render/texture/CompassSprite;tick()V", constant = @Constant(intValue = 256))
	private int fixLoopLength(int twoFiftySix){
		return TileSize.int_numPixels;
	}
	@ModifyConstant(method = "Lnet/minecraft/client/render/texture/CompassSprite;tick()V",
